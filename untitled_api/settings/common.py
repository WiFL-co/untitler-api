...
LOCAL_APPS = (
  ...
  # APPS
  # LIBS
  'untitled_api.libs.common_domain',
  'untitled_api.libs.communication_utils',
  'untitled_api.libs.django_utils',
)
...
CELERY_IMPORTS = (
  'untitled_api.libs.communication_utils.services.email_tasks',
)
